Drupal.locale = { 'pluralFormula': function ($n) { return Number(($n!=1)); }, 'strings': {"":{"An AJAX HTTP error occurred.":"Si \u00e8 verificato un errore HTTP in AJAX.","HTTP Result Code: !status":"Codice HTTP di risposta: !status","An AJAX HTTP request terminated abnormally.":"Una richiesta AJAX HTTP \u00e8 terminata in modo anomalo.","Debugging information follows.":"Di seguito le informazioni di debug.","Path: !uri":"Percorso: !uri","StatusText: !statusText":"StatusText: !statusText","ResponseText: !responseText":"ResponseText: !responseText","ReadyState: !readyState":"ReadyState: !readyState","Next":"Seguente","Status":"Stato","Remove":"Elimina","Disabled":"Disattivato","Enabled":"Attivato","Edit":"Modifica","Size":"Dimensione","Reset":"Ripristina","none":"nessuno","Default":"Predefinito","Sunday":"Domenica","Monday":"Luned\u00ec","Tuesday":"Marted\u00ec","Wednesday":"Mercoled\u00ec","Thursday":"Gioved\u00ec","Friday":"Venerd\u00ec","Saturday":"Sabato","Add":"Aggiungi","Filename":"Nome file","Configure":"Configura","Done":"Fatto","N\/A":"N\/D","OK":"OK","This field is required.":"Questo campo \u00e8 obbligatorio.","Prev":"Precedente","Mon":"Lun","Tue":"Mar","Wed":"Mer","Thu":"Gio","Fri":"Ven","Sat":"Sab","Sun":"Dom","January":"Gennaio","February":"Febbraio","March":"Marzo","April":"Aprile","May":"Mag","June":"Giugno","July":"Luglio","August":"Agosto","September":"Settembre","October":"Ottobre","November":"Novembre","December":"Dicembre","Show":"Mostra","Key":"Chiave","Undo":"Annulla ultima operazione","Select all rows in this table":"Seleziona tutte le righe in questa tabella","Deselect all rows in this table":"Deseleziona tutte le righe in questa tabella","Today":"Oggi","Jan":"Gen","Feb":"Feb","Mar":"Mar","Apr":"Apr","Jun":"Giu","Jul":"Lug","Aug":"Ago","Sep":"Set","Oct":"Ott","Nov":"Nov","Dec":"Dic","Su":"Do","Mo":"Lu","Tu":"Ma","We":"Noi","Th":"Gi","Fr":"Ve","Sa":"Sa","Not published":"Non pubblicato","Please wait...":"Attendere prego...","Hide":"Nascondi","mm\/dd\/yy":"mm\/gg\/aa","Not enabled":"Non abilitato","By @name on @date":"Da @name il @date","By @name":"Da @name","Not in menu":"Non nel menu","Alias: @alias":"Alias: @alias","No alias":"Nessun alias","New revision":"Nuova revisione","Drag to re-order":"Trascina per riordinare","Changes made in this table will not be saved until the form is submitted.":"I cambiamenti fatti a questa tabella non saranno salvati finch\u00e8 il form non viene inviato.","The changes to these blocks will not be saved until the \u003Cem\u003ESave blocks\u003C\/em\u003E button is clicked.":"I cambiamenti a questi blocchi non saranno salvati finch\u00e9 il bottone \u003Cem\u003ESalva blocchi\u003C\/em\u003E \u00e8 cliccato.","Show shortcuts":"Mostra scorciatoie","This permission is inherited from the authenticated user role.":"Questo permesso viene ereditato dal ruolo utente autenticato.","No revision":"Nessuna revisione","@number comments per page":"@number commenti per pagina","Requires a title":"Richiede un titolo","Not restricted":"Non limitato","(active tab)":"(scheda attiva)","Not customizable":"Non personalizzabile","Restricted to certain pages":"Limitato a certe pagine","The block cannot be placed in this region.":"Il blocco non pu\u00f2 essere posizionato in questa regione.","Hide summary":"Nascondi sommario","Edit summary":"Modifica sommario","Don\u0027t display post information":"Non mostrare le informazioni di pubblicazione","The selected file %filename cannot be uploaded. Only files with the following extensions are allowed: %extensions.":"Il file selezionato %filename non pu\u00f2 essere caricato. Sono consentiti solo file con le seguenti estensioni: %extensions.","Re-order rows by numerical weight instead of dragging.":"Riordina le righe utilizzando il peso numerico invece del trascinamento.","Show row weights":"Visualizza i pesi delle righe","Hide row weights":"Nascondi i pesi delle righe","Autocomplete popup":"Popup di autocompletamento","Searching for matches...":"Ricerca in corso...","Hide shortcuts":"Nascondi scorciatoie","Other":"Altro","Value":"Valore","Select all":"Seleziona tutto","Insert this token into your form":"Inserisci questo token nel form","First click a text field to insert your tokens into.":"Prima occorre cliccare sul campo di testo dove inserire i token.","all":"tutto","Media browser":"Media browser","Remove group":"Rimuovi gruppo","Apply (all displays)":"Applica (tutte le visualizzazioni)","Revert to default":"Ritorna al predefinito","Apply (this display)":"Applica (solo questa visualizzazione)","Select":"Scegliere","Loading...":"In caricamento...","Start upload":"Inizia caricamento","If you switch views, you will lose your selection.":"Se si cambia vista, la selezione verr\u00e0 azzerata.","Cannot continue, nothing selected":"Impossibile continuare, nessuna selezione effettuata","Slideshow":"Slideshow","Loading token browser...":"Caricamento del browser dei token...","Available tokens":"Token disponibili","Close":"Chiudi","Automatic alias":"Alias automatico","No name":"Nessun nome","Received an invalid response from the server.":"Risposta non valida dal server.","No style":"Nessuno stile","Downloads":"Download","Translatable":"Traducibile","Not translatable":"Non traducibile","Restricted to certain languages":"Limitato ad alcune lingue"}} };;
      ...
      $('.views_slideshow_controls_text_pause:not(.views-slideshow-controls-text-pause-processed)', context).addClass('views-slideshow-controls-text-pause-processed').each(function() {
        ...
        $(this).click(function() {
          if (Drupal.settings.viewsSlideshow[uniqueID].paused) {
            ...
            $(this).parent().children('.views_slideshow_controls_text_pause').removeClass('views-slideshow-controls-text-status-play');
            $(this).parent().children('.views_slideshow_controls_text_pause').addClass('views-slideshow-controls-text-status-pause');
          }
          else {
            Drupal.viewsSlideshow.action({ "action": 'pause', "slideshowID": uniqueID, "force": true });
            $(this).parent().children('.views_slideshow_controls_text_pause').removeClass('views-slideshow-controls-text-status-pause');
            $(this).parent().children('.views_slideshow_controls_text_pause').addClass('views-slideshow-controls-text-status-play');
          }
          return false;
        });
      });
...
(function ($) {
  ...
  $.ui.autocomplete.prototype._renderItem = function (ul, item) {
    ...
    if (item.fields) {
      $.each(item.fields, function(key, value) {
        ...
        if (value.indexOf('src=') == -1 && value.indexOf('href=') == -1) {
          if (output.search(regex) >= 0) {
          	nomatch = ' ui-autocomplete-match ';
            output = output.replace(regex, "<span class='ui-autocomplete-field-term'>$1</span>");
            innerHTML += ('<div class="ui-autocomplete-field-' + key + ' ui-autocomplete-match">' + output + '</div>');
          } else {
          	 nomatch = ' ui-autocomplete-no-match ';
             innerHTML += ('<div class="ui-autocomplete-field-' + key + ' ui-autocomplete-no-match">' + output + '</div>');
          }         	
        } else {
    ...
    var elem =  $("<li class='ui-menu-item-" + first + nomatch + "'></li>" )
